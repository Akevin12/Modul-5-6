 ...
 * @author kevin
 */
public class Perekaman extends JFrame {
    ...
    public Perekaman() {
        ...
        label20.setText("Republik Harapan Bangsa");
        label20.setBounds(10, 30, 600, 30);
        ...
        UtilDateModel modelPembuatan = new UtilDateModel();
        JDatePanelImpl datePanelPembuatan = new JDatePanelImpl(modelPembuatan, p);
        JDatePickerImpl datePickerPembuatan = new JDatePickerImpl(datePanelPembuatan, new Controller.DateLabelFormatter());
        datePickerPembuatan.setBounds(950, 620, 200, 30);

        JButton btnSave = new JButton("INSERT");
        btnSave.setBounds(500, 680, 150, 40);

        JButton btnExit = new JButton("EXIT");
        btnExit.setBounds(700, 680, 150, 40);
        ...
        btnSave.addActionListener(
            ...
            public void actionPerformed(ActionEvent ae
                ...
                if (nik.getText().isEmpty() || nama.getText().isEmpty() || tmptLahir.getText().isEmpty() || Controller.Controller.findJK(jk1, jk2).isEmpty()
                    ...
                    Controller.Controller.insertData(nik.getText(), nama.getText(),
                    ...
                    new HasilKTP(label20.getText(), nik.getText(), nama.getText(),
                            tmptLahir.getText(), ttl, Controller.Controller.findJK(jk1, jk2),
                            Controller.Controller.findGoldar(gd1, gd2, gd3, gd4), alamat.getText(), rt.getText(),
                            kel.getText(), kec.getText(), (String) agama.getSelectedItem(),
                            (String) pernikahan.getSelectedItem(), Controller.Controller.listPekerjaan(pk1, pk2, pk3, pk4, pk5),
                            Controller.Controller.findWNA(wni, wna, cWNA), iconGbr.getIcon(), iconTTD.getIcon(),
                            masa.getText(), kota.getText(), buatKTP);
                }
            }
        });
